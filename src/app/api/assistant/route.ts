...
• Calc. APTC: calcula el crédito fiscal según ingreso anual, tamaño de familia y edades (los valores FPL se actualizan cada enero en Configuración → Cálculos y AI).
  ...
  LLAVE DEL CMS (rotación): desde el 26/10/2026 CMS caduca las API Keys del Marketplace cada 60 días y envía la nueva por correo automáticamente (con 30 días de margen antes de borrar la vieja). OJO: el enlace del correo con la llave nueva se destruye tras abrirse UNA vez (o a los 7 días), así que hay que copiarla con cuidado al abrirla y pegarla enseguida en Configuración → Cálculos y AI → CMS API Key (solo el dueño del CRM ve ese campo). Si la Calculadora APTC empieza a decir que CMS rechazó la llave, esa es la causa: buscar el correo de cms.hhs.gov con la llave nueva.
